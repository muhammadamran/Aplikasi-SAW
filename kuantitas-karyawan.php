...
{    
	$id_kuantitas        = $_POST['id_kuantitas'];
  ...
  $query = mysql_query("INSERT INTO kuantitas 
    (id_kuantitas,id_alternatif,target,kegiatan,bulan,tahun) 
    VALUES 
    ('','$id_alternatif','$target','$kegiatan','$bulan','$tahun')
    ");
  if ($query) {
    header("Location: ./kuantitas-karyawan.php?ntf=1");  
  } else {
    header("Location: ./kuantitas-karyawan.php?ntf=6");
  }
}
...
{    
  ...
  $query = mysql_query("UPDATE kuantitas SET 
    ket_crips ='$ket_crips',
    nilai_crips ='$nilai_crips'
    WHERE id_kuantitas ='$id_kuantitas'");
  if($query){
    header("Location: ./kuantitas-karyawan.php?ntf=4");                                                  
  } else {
...
if(isset($_POST['delete']))
{
  ...
  if($id_kuantitas){
    $query = mysql_query("DELETE FROM kuantitas WHERE id_kuantitas = '$id_kuantitas'");
    if($query){
     header("Location: ./kuantitas-karyawan.php?ntf=3");                     
   } else {
    header("Location: ./kuantitas-karyawan.php?ntf=6");  
  }
} else {
...
<section class="content">
  <div class="container-fluid">
    <div class="block-header">
      <h2>DATA KUANTITAS KARYAWAN PAGE</h2>
    </div>
    ...
    <div class="row clearfix">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                <div class="modal-header">
                  <label class="modal-title">Tambah Data Kuantitas Karyawan</label>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <input type="hidden" class="form-control" name="id_kuantitas">
                      ...
                      <div class="col-sm-12">
                        <div class="form-group">
                          <label>Target<font style="color: red">*</font></label>
          ...
          <!-- ALERT -->
          <div class="header">
            <button type="button" class="btn btn-success btn-circle waves-effect waves-circle waves-float" data-toggle="modal" data-target="#modal-add"><i class="material-icons">add_circle</i>
            </button>
          </div>
          <div class="body">
              ...
              <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                ...
                <tbody>
                  ...
                  $result = mysqli_query($con,"SELECT a.id_alternatif,a.inisial_alternatif,a.nama_alternatif,a.hasil_alternatif,
                    b.id_kuantitas,b.id_alternatif,b.target,b.kegiatan,b.ket_crips,b.nilai_crips,b.bulan,b.tahun
                    FROM alternatif a JOIN kuantitas b
                    ON a.id_alternatif=b.id_alternatif ORDER BY b.id_kuantitas ASC");
                  ...
                  if(mysqli_num_rows($result)>0){
                    while($row = mysqli_fetch_array($result))
                    {
                      ...
                      $ban = $row['kegiatan'];
                      $persen = 100;
                      $nilai_kuantitas = ($jum + $ban) / 2;
                      echo "<tr>";
                      echo "<td>".$row['inisial_alternatif'] . "</td>";
                      echo "<td>".$row['nama_alternatif'] . "</td>";
                      echo "<td>".$row['target'] . "</td>";
                      echo "<td>".$row['kegiatan'] . "</td>";
                      echo "<td>".round($nilai_kuantitas) . "</td>";
                                                // if($nilai_kuantitas >= 90 OR $nilai_kuantitas >= 100 ){
                                                //     echo "<td>SANGAT BAIK</td>";
                                                // }elseif($nilai_kuantitas >= 80 OR $nilai_kuantitas >= 89 ){
                                                //     echo "<td>BAIK</td>";
                                                // }elseif($nilai_kuantitas >= 70 OR $nilai_kuantitas >= 79 ){
                                                //     echo "<td>CUKUP</td>";
                                                // }elseif($nilai_kuantitas >= 0 OR $nilai_kuantitas >= 69 ){
                                                //     echo "<td>KURANG</td>";
                                                // }
                                                // if($nilai_kuantitas >= 90 OR $nilai_kuantitas >= 100 ){
                                                //     echo "<td>4</td>";
                      ...
                      if($row['ket_crips']==NULL){
                        ...
                        <button type='button' data-toggle='modal' data-target='#datacrips$row[id_kuantitas]' title='Delete'class='btn btn-warning btn-circle waves-effect waves-circle waves-float btn-sm'><i class='material-icons'>loop</i></button>
                        </td>";
                      }else{
                      ...
                      <button type='button' data-toggle='modal' data-target='#delete$row[id_kuantitas]' title='Delete'class='btn btn-danger btn-circle waves-effect waves-circle waves-float'><i class='material-icons'>delete</i></button>
                      </td>";
                      echo "</tr>";
                      ?>
                      <!-- UPDATE -->
                      <div class="modal fade" id="datacrips<?php echo $row['id_kuantitas'];?>">
                        <div class="modal-dialog modal-xl">
                          <div class="modal-content">
                            <div class="modal-header">
                              <label class="modal-title">Update Data Keterangan Crips Kuantitas Karyawan</label>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                                ...
                                <div class="row">
                                  <div class="col-sm-12">
                                    <div class="form-group">
                                      ...
                                      <input type="hidden" class="form-control" name="id_kuantitas" value="<?php echo $row['id_kuantitas']; ?>">
                                      <!-- KETERANGAN -->
                                      <?php
                                      if(round($nilai_kuantitas) >= 9 OR round($nilai_kuantitas) >= 10 ){
                                        ?>
                                        <input type="hidden" class="form-control" name="ket_crips" value="SANGAT BAIK">
                                        <?php
                                      }elseif(round($nilai_kuantitas) >= 7 OR round($nilai_kuantitas) >= 8 ){
                                        ?>
                                        <input type="hidden" class="form-control" name="ket_crips" value="BAIK">
                                        <?php
                                      }elseif(round($nilai_kuantitas) >= 5 OR round($nilai_kuantitas) >= 6 ){
                                        ?>
                                        <input type="hidden" class="form-control" name="ket_crips" value="CUKUP">
                                        <?php
                                      }elseif(round($nilai_kuantitas) >= 0 OR round($nilai_kuantitas) >= 4 ){
                                        ?>
                      ...
                      <!-- UPDATE -->
                      <div class="modal fade" id="edit<?php echo $row['id_kuantitas'];?>">
                        <div class="modal-dialog modal-xl">
                          <div class="modal-content">
                            <div class="modal-header">
                              <label class="modal-title">Update Data Data Kuantitas Karyawan</label>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                      ...
                      <!-- DELETE -->
                      <div class="modal fade" id="delete<?php echo $row['id_kuantitas'];?>" role="dialog">
                            ...
                            <div class="modal-body">
                              <form method="post" action="">
                                <div class="form-group">
                                  ...
                                  <input type="hidden" name="id_kuantitas" class="form-control" value="<?php echo $row['id_kuantitas'];?>" required>
